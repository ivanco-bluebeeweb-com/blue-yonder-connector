"""Pydantic schemas for Blue Yonder Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Blue Yonder.")
    api_key: str = Field(description="Logistics API Key / Access Token")
    base_url: str = Field(default="https://api.blueyonder.com/supplychain/v1", description="Blue Yonder API base URL.")
...
class GetShipmentParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    shipment_id: str = Field(description="Blue Yonder Shipment ID.")
