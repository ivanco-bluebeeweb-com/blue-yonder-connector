"""Settings panel for Blue Yonder Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__blue_yonder_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=blue_yonder_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_blue_yonder"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Blue Yonder Settings & Accounts", level=2),
